...
export function getExercisesByMuscleGroup(muscleGroupName: string): Exercise[] {
...
export function addExerciseToProgram(exercises: Exercise[], newExercise: Exercise): Exercise[] {
...
export function removeExerciseFromProgram(exercises: Exercise[], exerciseToRemove: Exercise, index?: number): Exercise[] {
...
export function reorderExercises(exercises: Exercise[], fromIndex: number, toIndex: number): Exercise[] {
...
export function getMuscleGroupByExercise(exerciseName: string): MuscleGroup | null {
...
export function validateExercise(exercise: Partial<Exercise>): { isValid: boolean; errors: string[] } {
